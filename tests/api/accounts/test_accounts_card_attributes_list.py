...
@allure.description(
    """
    GET /accounts/{id}/cards/{cardId}/attributes/
    """
)
class TestAccountsCardAttributesList:
    @allure.title("POST /Accounts/{id}/Cards -> GET /accounts/{id}/cards/{cardId}/attributes/ -> DELETE")
    @pytest.mark.smoke
    def test_accounts_card_attributes_list_200(self, cfg):
        card_id = None
        try:
            ...
            with allure.step(f"GET /accounts/{cfg['lk_account_id']}/cards/{card_id}/attributes/"):
                response, model = AccountsCardAttributesListAPI().get_accounts_card_attributes(
    ...
    @pytest.mark.ng
    @allure.title("GET /accounts/{id}/cards/{cardId}/attributes/ without auth -> 401/403")
    def test_accounts_card_attributes_list_401_without_auth(self, cfg):
        response = AccountsCardAttributesListAPI().get_accounts_card_attributes_without_auth(
            int(cfg["lk_account_id"]),
            card_id=1,
        )
