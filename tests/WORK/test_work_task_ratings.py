...
class TestWorkTaskRatings(BaseTest):

    @allure.title('Test add task ratings.')
    @allure.testcase("https://dev.azure.com/melston/HubEx/_workitems/edit/24467")
    @pytest.mark.regress
    @pytest.mark.test_case_id(24467)
    def test_post_task_ratings(self):
