...
class TestWorkTemplateQuickResponse(BaseTest):
    ...
    @pytest.mark.regress
    @pytest.mark.test_case_id(25320)
    ...
    @allure.testcase("https://dev.azure.com/melston/HubEx/_workitems/edit/25317")
    @pytest.mark.regress
    @pytest.mark.test_case_id(25317)
    ...
    @allure.testcase("https://dev.azure.com/melston/HubEx/_workitems/edit/25319")
    @pytest.mark.regress
    @pytest.mark.test_case_id(25319)
    ...
    @allure.testcase("https://dev.azure.com/melston/HubEx/_workitems/edit/25321")
    @pytest.mark.regress
    @pytest.mark.test_case_id(25321)
    ...
    @allure.testcase("https://dev.azure.com/melston/HubEx/_workitems/edit/25322")
    @pytest.mark.regress
    @pytest.mark.test_case_id(25322)
