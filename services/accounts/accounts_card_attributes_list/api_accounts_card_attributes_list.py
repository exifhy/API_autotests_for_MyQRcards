...
from services.accounts.accounts_card_attributes_list.endpoints import Endpoints
...
class AccountsCardAttributesListAPI(Helper):
    def __init__(self):
        self.endpoints = Endpoints()

    @allure.step("GET /accounts/{account_id}/cards/{card_id}/attributes/")
    def get_accounts_card_attributes(
        self,
        account_id: int,
        card_id: int,
        *,
        ...
        response = self._call(
            "GET",
            url=self.endpoints.get_accounts_card_attributes_endpoint.format(
    ...
    @allure.step("GET /accounts/{account_id}/cards/{card_id}/attributes/ without auth")
    def get_accounts_card_attributes_without_auth(self, account_id: int, card_id: int) -> requests.Response:
        response = self._call(
            "GET",
            url=self.endpoints.get_accounts_card_attributes_endpoint.format(
                account_id=int(account_id),
