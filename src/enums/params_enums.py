...
class Params(Enum):
    ...
    params_negative_add_materials_body = [
        ...
        pytest.param({
                ...
                "PurchaseCost": 10.50,
                "purchaseCostCurrencyID": 1,
            }, "Creating material with exceeding character limits description=513.",
            "The field Description must be a string with a maximum length of 512.",
            id="Test creating material with exceeding character limits description=513."),
        pytest.param({
                "name": f"Материал {random.randint(1, 99999)}",
                "erpID": f"MErpID {random.randint(1, 99999)}",
                "vendorCode": "A"*33,
    ...
    params_negative_update_material_body = [
        ...
        pytest.param({
                ...
                "PurchaseCost": 10.50,
                "purchaseCostCurrencyID": 1,
            }, "Update material with exceeding character limits description=513.",
            "The field Description must be a string with a maximum length of 512.",
            id="Test update material with exceeding character limits description=513."),
        pytest.param({
                "name": f"Материал {random.randint(1, 99999)}",
                "erpID": f"MErpID {random.randint(1, 99999)}",
                "vendorCode": "A"*33,
